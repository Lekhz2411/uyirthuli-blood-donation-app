...
import com.example.uyirthuli.Adapter.BloodDonorAdapter;
import com.example.uyirthuli.Common.Common;
import com.example.uyirthuli.Model.MyResponse;
import com.example.uyirthuli.Model.Notification;
...
//                                    && !user.getPhone().equals(Common.currentUser.getPhone())) {
                            ...
                            if (user.getBloodGroup().equalsIgnoreCase(blood) && !user.getPhone().equals(Common.currentUser.getPhone())) {
